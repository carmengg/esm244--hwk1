...
The biplot shown in figure 1 shows there is a similar and large variance with respect to PC1 and PC2 across energy, fat and protein content, while sugar content has a small variance. 
...
- Cheeses from the US form the tightest cluster, with cottage cheese as an outlier. Mexican cheeses also form a small cluster with small coefficients on both PC1 and PC2.
