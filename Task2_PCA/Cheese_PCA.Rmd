...
subtitle: "ESM 244 - Advanced Daya Analysis : Homework 1"
...
### Introduction
In this report we perform a principal component analysis on the nutrition data for 45 types of cheeses and examine whether cheeses with same country of origin form data clusters. 
The variables used in the analysis are energy (kcal), protein (g), fat (g), carbohydarate (g) and sugar (g) present in $x$ grams of cheese. 
...
# update labels
cheese_biplot <- cheese_biplot +
  labs(colour="Country of origin") +
